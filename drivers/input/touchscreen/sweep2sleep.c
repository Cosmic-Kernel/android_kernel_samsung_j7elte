 ...
 * |
 * -------- Y_LIMIT ------------
 * 0<-B0-B3-B1--|--B4-B2-B5->X_MAX
 * --------- Y_MAX -------------
 */

/* Sweep2sleep right to left */
#define DEFAULT_S2W_X_B0		120
#define DEFAULT_S2W_X_B1		DEFAULT_S2W_X_B0+150
#define DEFAULT_S2W_X_B2		DEFAULT_S2W_X_B0+420

/* Sweep2sleep left to right */
#define DEFAULT_S2W_X_B3		DEFAULT_S2W_X_B0+60
#define DEFAULT_S2W_X_B4		DEFAULT_S2W_X_MAX-270
...
static int input_dev_filter(struct input_dev *dev) {
	if (strstr(dev->name, "touch") ||
	    strstr(dev->name, "ist30xx") ||
	    strstr(dev->name, "ist30xx-ts")) {
		return 0;
	} else {
		return 1;
	}
